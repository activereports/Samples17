...
private System.Windows.Forms.TabPage tabSqliteDb;
...
private System.Windows.Forms.Label lblSqliteDb;
private System.Windows.Forms.Button btnSqliteDb;
...
private void InitializeComponent()
{
	...
	this.tabSqliteDb = new System.Windows.Forms.TabPage();
	this.btnSqliteDb = new System.Windows.Forms.Button();
	this.lblSqliteDb = new System.Windows.Forms.Label();
	...
	this.tabSqliteDb.SuspendLayout();
	...
	this.tabDataBinding.Controls.Add(this.tabSqliteDb);
	...
	// tabSqliteDb
	// 
	this.tabSqliteDb.Controls.Add(this.btnSqliteDb);
	this.tabSqliteDb.Controls.Add(this.lblSqliteDb);
	resources.ApplyResources(this.tabSqliteDb, "tabSqliteDb");
	this.tabSqliteDb.Name = "tabSqliteDb";
	// 
	// btnSqliteDb
	// 
	resources.ApplyResources(this.btnSqliteDb, "btnSqliteDb");
	this.btnSqliteDb.Name = "btnSqliteDb";
	this.btnSqliteDb.Click += new System.EventHandler(this.btnSqliteDb_Click);
	// 
	// lblSqliteDb
	// 
	resources.ApplyResources(this.lblSqliteDb, "lblSqliteDb");
	this.lblSqliteDb.Name = "lblSqliteDb";
	// 
	// tabXML
	// 
	...
	this.tabSqliteDb.ResumeLayout(false);
