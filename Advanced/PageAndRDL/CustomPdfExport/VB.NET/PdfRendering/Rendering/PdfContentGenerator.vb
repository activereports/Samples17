...
#Region "IDrawingCanvas implementation"
	...
	Public Function CreateLinearGradientBrush(point1 As PointF, point2 As PointF, color1 As Color, color2 As Color, stops As IEnumerable(Of GradientStopColor)) As BrushEx Implements IDrawingCanvas.CreateLinearGradientBrush
		Return New LinearGradientBrush(point1, point2, color1, color2)
	End Function

	Public Function CreateRadialGradientBrush(centerPoint As PointF, focusPoint As PointF, centerRadius As PointF, centerColor As Color, surroundingColor As Color, stops As IEnumerable(Of GradientStopColor), brushBounds As RectangleF?, brushTransform As Matrix3x2?) As BrushEx Implements IDrawingCanvas.CreateRadialGradientBrush
		Return New SolidBrush(centerColor)
	End Function
...
#Region "Helpers"
	...
	Private Shared Function GetAlignment(format As StringFormatEx) As XParagraphAlignment
		If (format.Alignment And StringAlignmentEx.Justify) <> 0 Then
