...
Imports GrapeCity.ActiveReports.Layout
...
#Region "Default CRI implementation"
		...
		Public ReadOnly Property EndSection As EndSection Implements IPageRegion.EndSection
			Get
				Dim newPage = CStr(_properties.GetValue("NewPage"))
				Dim result As StartNewPage = Nothing
				Return If([Enum].TryParse(newPage, True, result), result.ToEndSection(), EndSection.PageBreak)
			End Get
		End Property
