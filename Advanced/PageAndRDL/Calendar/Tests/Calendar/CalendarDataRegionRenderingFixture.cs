...
namespace GrapeCity.ActiveReports.Calendar.Tests.Calendar
{
	...
	public class CalendarDataRegionRenderingFixture
	{
		...
		internal IDrawingCanvas GetCanvas()
		{
			return GraphicsCanvasFactory.Create(GetGraphics(), null, GraphicsCanvasFactory.DefaultSettings);
        }
		...
		public void CalendarDefaultRenderingTest()
		{
			...
			IDrawingCanvas canvas = GetCanvas();
		...
		public void TestRenderingInMultiThreads()
		{
			...
			System.Action render = () =>
			{
				...
				{
					var canvas = GraphicsCanvasFactory.Create(graphics, null, GraphicsCanvasFactory.DefaultSettings);
